...
class MyServerCallbacks : public BLEServerCallbacks {
  ...
  void notify_done() { Serial.println("notify_done..."); }
};
...
void setup()
{
  ...
  pCharacteristic1 = pService->createCharacteristic(CHARACTERISTIC_UUID1, BLECharacteristic::PROPERTY_READ |
                                                                            BLECharacteristic::PROPERTY_WRITE |
                                                                            BLECharacteristic::PROPERTY_NOTIFY);

  pCharacteristic2 = pService->createCharacteristic(CHARACTERISTIC_UUID2, BLECharacteristic::PROPERTY_WRITE |
...
void loop()
{
  ...
  if (deviceConnected) {
    ...
    delay(500); // bluetooth stack will go into congestion, if too many packets are sent, in 6 hours test i was able to
                // go as low as 3ms
